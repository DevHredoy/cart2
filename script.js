...
//lets make basic card component
...
const bodycontents=document.getElementById("body-contnent").innerHTML ;


document.getElementById("body-content").innerHTML = uniqueFruits.map((item)=>
{var{
image,title,price
}=item;
return(
...
// bodyContents.innerHTML= uniqueFruits.map((item) => {
...
// Now you can append bodyContents to the root element
// root.innerHTML = bodyContents;
